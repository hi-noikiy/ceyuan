...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">部门管理</a><span class="crumb-step">&gt;</span><span>新增医生</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo ($doctorres["id"]); ?>">
                    <table class="insert-tab" width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="name" size="50" value="<?php echo ($doctorres["name"]); ?>" type="text">
                                </td>
                            </tr>
                            
                              <tr>
                                <th><i class="require-red">*</i>医生性别：</th>
                                <td>
							...
							<!--选择医院模块-->
                           <tr>
                                <th><i class="require-red">*</i>所属医院：</th>
                                <td>
                                  <select id="uid" name="uid">
                                  		<option value="">请选择</option>
                                  		<?php if(is_array($hospitalres)): $i = 0; $__LIST__ = $hospitalres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  <?php if($doctorres["uid"] == $vo["id"] ): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                  </select>
                                </td>
                            </tr>  
                            <!--选择医院模块-->
