...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">全部数据</span></div>
        </div>
        <div class="search-wrap">
          <div class="search-content">
                <form  style="display:inline-block;" action="/Admin/Trouble/search" method="post">
        ...
        <?php
                            ...
                            <td width="7%"><?php echo ($vo["adduser"]); ?></td>
