...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">系统设置</a><span class="crumb-step">&gt;</span><span>邮箱设置</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                	<input type="hidden" name="id" value="<?php echo ($mailres["id"]); ?>">
                    <table class="insert-tab" width="100%">
                    
                        <tbody>
                        
                            <tr>
                                <th><i class="require-red">*</i>SMTP服务器：</th>
                                <td>
                                    <input class="common-text required" id="smtp" name="smtp" size="50" value="<?php echo ($mailres["smtp"]); ?>" type="text">
                                </td>
                            </tr>
                            
                            <tr>
                                <th><i class="require-red">*</i>邮箱帐号：</th>
                                <td>
                                    <input class="common-text required" id="user" name="user" size="50" value="<?php echo ($mailres["user"]); ?>" type="text">
                                </td>
                            </tr>
                            
                            <tr>
                                <th><i class="require-red">*</i>邮箱密码：</th>
                                <td>
                                    <input class="common-text required" id="pass" name="pass" size="50" value="<?php echo ($mailres["pass"]); ?>" type="text">
                                </td>
                            </tr>
                            
                            
                            <tr>
                                <th><i class="require-red">*</i>来源名称：</th>
                                <td>
                                    <input class="common-text required" id="from" name="from" size="50" value="<?php echo ($mailres["from"]); ?>" type="text">
                                </td>
                            </tr>
                        ...
                        <br/>
                        <div class="crumb-list"><i class="icon-font">&#xe021;</i><span class="crumb-name"> : 邮箱功能主要用于用户自助找回密码,添加的邮箱帐号需要开启SMTP服务才能正常服务.</span></div><strong></strong>
