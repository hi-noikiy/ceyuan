...
<head>
    ...
    <script type="text/javascript" src="/Crm/Admin/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="/Crm/Admin/Public/ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" src="/Crm/Admin/Public/ueditor/lang/zh-cn/zh-cn.js"></script>        
</head>
<body>
<!--引入公共head-->
...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">公告管理</a><span class="crumb-step">&gt;</span><span>新增公告</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                           ...
                           <tr>
                                ...
                                <td>
									<?php if(is_array($hospitalres)): $i = 0; $__LIST__ = $hospitalres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="sendto[]" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>&nbsp&nbsp<?php endforeach; endif; else: echo "" ;endif; ?>
                                </td>
                            </tr>  
