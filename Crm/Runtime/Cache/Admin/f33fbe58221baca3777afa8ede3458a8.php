...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">反馈列表</span></div>
        </div>
        <div class="search-wrap">
          <div class="search-content">
                <form  action="/index.php/Admin/Trouble/search" method="post">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/index.php/Admin/Trouble/sort">
...
<!--                            <td><img src="<?php echo ($vo["firstimg"]); ?>"></td>-->
                            <td width="10%">
                                <a class="link-update" href="/index.php/Admin/Trouble/view/id/<?php echo ($vo["id"]); ?>">查看详情</a>
                                <a class="link-del" onClick="return confirm('你确定要删除吗?')"href="/index.php/Admin/Trouble/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
