...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">待整改列表</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/Admin/Trouble/sort">
                ...
                <div class="result-content">
                    <table id="tab-list" class="result-tab" width="100%">
                        <tr>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td  width="6%"><?php echo ($vo["office"]); ?></td>
                            <td  width="10%"><?php echo ($vo["place"]); ?></td>
                            <td  width="10%">
        ...
        <?php
                            ...
                            <td width="15%" style="text-align:center;"><img    style="width:100%;height:300px;"   src="<?php echo ($vo["firstimg"]); ?>"></td>
                            <td width="15%"><img    style="width:100%;height:300px;"  src="<?php echo ($vo["lastimg"]); ?>"></td>
                             <td width="7%"><?php echo ($vo["cishu"]); ?></td>
                            <td width="6%"><?php echo ($vo["adduser"]); ?></td>
                            <td width="6%"><?php  echo date('Y-m-d',$vo['addtime']); ?></td>
                            <td width="6%"><?php  echo date('Y-m-d',$vo['lasttime']); ?></td>
<!--                            <td><img src="<?php echo ($vo["firstimg"]); ?>"></td>-->
                            <td width="10%">
                                <a class="link-update" href="/Admin/Trouble/view/id/<?php echo ($vo["id"]); ?>">查看详情</a>
