                        ...
                        <tbody>
                            ...
                            <tr id="diy" style="display:none;">
                                ...
                                <td id="models">
                                        ...
                                        <?php if(is_array($departmentres)): $i = 0; $__LIST__ = $departmentres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dvo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="diy" value="<?php echo ($dvo["id"]); ?>"><?php echo ($dvo["name"]); ?>&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
