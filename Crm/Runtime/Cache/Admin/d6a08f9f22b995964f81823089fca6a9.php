...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="">审核中的列表</a><span class="crumb-step">&gt;</span><span>查看需要审核的问题</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form onsubmit="return jiance();" action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
...
<input class="common-text required" id="name" name="name" size="50" readonly  value="<?php echo date('Y-m-d',$troubleres['addtime']) ?>" type="text">
                            ...
                            <tr>
                                <th><i class="require-red"></i>后台审批：</th>
                                <td>
                                <select name="state" id="state" onChange="openyy();">
                            ...
                            <tr  id="yuanyin" style="display:none;">
                                ...
                                <td>
                                    ...
                                    <textarea name="yuanyin" id="yuanyina" style="width:30%;"></textarea>
				   ...
				   function jiance(){
					   var obj = document.getElementById('state'); //定位id

var index = obj.selectedIndex; // 选中索引
var value = obj.options[index].value; // 选中值
 var yuanyin = document.getElementById('yuanyina').value; //定位id
...
<input class="common-text required" id="name" name="name" size="50" readonly  value="<?php echo $troublelistres[$i][addtime]; ?>" type="text">
 ...
 if($troublelistres[$i][yuanyin]){ ?>     
                ...
                <br/>
                <div class="crumb-list"><i class="icon-font">&#xe021;</i><span class="crumb-name"> : 当前记录是清洁人员已经整改,等待后台/检查人员进行审批.</span></div>
            </div>
