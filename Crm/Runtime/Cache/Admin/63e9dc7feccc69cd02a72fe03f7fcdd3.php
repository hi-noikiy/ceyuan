...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">系统设置</a><span class="crumb-step">&gt;</span><span>安全设置</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>后台超时时间：</th>
                                <td>
                                    <input class="common-text required" id="name" name="name" size="50" value="" type="text">(单位时间:s)
                                </td>
                            </tr>
                            
                            <tr>
                                <th><i class="require-red">*</i>前台超时时间：</th>
                                <td>
                                    <input class="common-text required" id="name" name="name" size="50" value="" type="text">(单位时间:s)
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>强制退出设置：</th>
                                <td>
                                    <input type="checkbox" name="qzsafe[]" value="1">UA更换                                    <input type="checkbox" name="qzsafe[]" value="2">IP更换
                                </td>
                            </tr>
