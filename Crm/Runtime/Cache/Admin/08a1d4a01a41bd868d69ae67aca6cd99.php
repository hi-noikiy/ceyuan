            ...
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                    	<input type="hidden" name="id" value="<?php echo ($hospitalres["id"]); ?>"/>
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>医院名称：</th>
                                <td>
                                    <input class="common-text required" id="name" name="name" size="50" value="<?php echo ($hospitalres["name"]); ?>" type="text">
                                </td>
                            </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="website" name="website" size="50" value="<?php echo ($hospitalres["website"]); ?>" type="text">
                                </td>
                            </tr>                       
                            <tr>
                                <th><i class="require-red">*</i>显示顺序：</th>
                                <td>
                                    <input class="common-text required" id="sort" name="sort" size="50" value="<?php echo ($hospitalres["sort"]); ?>" type="text">
                                </td>
                            </tr>                          
                            <tr>
                                <th></th>
