...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">用户列表</span></div>
        </div>
        <div class="search-wrap">
          <div class="search-content">
                <form  action="/index.php/Admin/User/search" method="post">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/index.php/Admin/User/Index/sort/1/">
                <div class="result-title">
                    <div class="result-list">
                      	<a href="/index.php/Admin/User/add"><i class="icon-font"></i>新增用户</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td width="10%">
                                <a class="link-update" href="/index.php/Admin/User/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onClick="return confirm('警告:你确定要删除<?php echo ($vo["username"]); ?>吗?')"href="/index.php/Admin/User/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                   <div class="list-page"><?php echo ($page); ?></div>
<div class="crumb-list"><i class="icon-font">&#xe021;</i><span class="crumb-name"> :除了Admin以外的帐号只能在前台登陆</span></div>
                </div>
            </form>
        </div>
    </div>
