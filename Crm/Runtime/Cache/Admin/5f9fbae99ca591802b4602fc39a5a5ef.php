...
<!--引入公共sidebar-->
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">审核中列表</span></div>
        </div>
        ...
        <?php
                            ...
                            <td width="15%"><img style="width:100%;height:300px;" src="<?php echo ($vo["lastimg"]); ?>"></td>
                                    ...
                                    <td  width="7%"><?php echo ($vo["cishu"]); ?></td>                    <td  width="7%"><?php echo ($vo["adduser"]); ?></td>
                            <td  width="7%"><?php  echo date('Y-m-d',$vo['addtime']); ?></td>
                            <td width="7%"><?php  echo date('Y-m-d',$vo['lasttime']); ?></td>
                      
                            <td width="10%">
                                <a class="link-update" href="/Admin/Trouble/edit/id/<?php echo ($vo["id"]); ?>">查看详情</a>
